...
!Loop over j provides entire spectrum of radii  
!  do j=1,100
    j=5
    Xi_c=0.92!0.1*j      !!!!!Change this to adjust the core radius
...
!  print*, "Mcore", Mcore
!  print*, "Mt", Mt
    print*, "Mc=", Mc,"Rc=",Rc  !, R1(Nc)
  
  
  
  open(unit=14,file='test.dat')	 !!!Change
    do i=1,Nc
      write(14,*) R1(i)/R2(Ne), Rho1(i)
    enddo
    do i=2,Ne
      write(14,*) R2(i)/R2(Ne), Rho2(i)
    enddo
   close(14)
  print*, "File test.dat printed."      !!!Change

    open(unit=12,file='ana_83_51.dat',access='APPEND')  
    write(12,*) Rc,Mc
    close(12)
